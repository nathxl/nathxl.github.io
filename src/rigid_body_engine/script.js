...
const sp1 = new SubParticle(new Vector(70, 35, 0), 1);
const sp2 = new SubParticle(new Vector(165, 50, 0), 1);
const sp3 = new SubParticle(new Vector(200, 125, 0), 5);
const sp4 = new SubParticle(new Vector(75, 140, 0), 1);
const sp5 = new SubParticle(new Vector(50, 100, 0), 1);
