class Ball {
    ...
    hit(hitFactor, mousePos) {
        const hitDirection = mousePos.substract(this.r).unit();
        const hitVector = hitDirection.multiply(hitFactor);
    ...
    reposition() {
        ...
        this.a = this.a.unit().multiply(this.acceleration);
        this.v = this.v.add(this.a).multiply(1 - this.friction);
